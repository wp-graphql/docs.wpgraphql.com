...
<Note type="warning">
If any of the semantics of the GraphQL queries/mutations on this page are confusing, check out the:
<br/><br/>
<a href="/docs/getting-started/intro-to-graphql"><Button type="primary">Intro to GraphQL Guide</Button></a>
</Note>
